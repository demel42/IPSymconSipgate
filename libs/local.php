...
trait SipgateLocalLib
{
    public static $IS_NOSYMCONCONNECT = IS_EBASE + 1;
    public static $IS_NOLOGIN = IS_EBASE + 2;
    public static $IS_INVALIDCONFIG = IS_EBASE + 3;

    public static $IS_UNAUTHORIZED = IS_EBASE + 4;
    public static $IS_SERVERERROR = IS_EBASE + 5;
    public static $IS_HTTPERROR = IS_EBASE + 6;
    public static $IS_NODATA = IS_EBASE + 7;
    public static $IS_INVALIDDATA = IS_EBASE + 8;
